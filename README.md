## CsvConsoleUtility - консольная утилита написанная на языке php, позволяет конвертировать входной csv файл в исходный csv файл по правилам описанным в конфигаруационном файле
### Необходимое ПО
